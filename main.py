...
class Sniper:
    ...
    def __init__(self):
        ...
        self.vanity_url = config.get("infaz213")

        self.guild_id = config.get("1110569599591788655")

        self.token = config.get("MTEwNTUxMDcyNjQ5MzI3NDE1Mg.GjWfqY.PdoKs4k6LEoaCyMngo6_6BgDhzQ2dhu8-gp0UA")
